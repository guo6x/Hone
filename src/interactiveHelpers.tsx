 ...
 * Use this for fatal errors after the Ink root has been created ... * console.error is swallowed by Ink's patchConsole, so we render
 ...
 * Use this for messages after the Ink root has been created ... * console output is swallowed by Ink's patchConsole, so we render
 * through the React tree instead.
 */
  ...
  return {
    ...
    renderOptions: {
      ...
      onFrame: event => {
        ...
        // Skip flicker reporting for terminals with synchronized output ...        // DEC 2026 buffers between BSU/ESU so clear+redraw is atomic.
