...
const DEFAULT_PREFIX = `You are Hone (磨石), an interactive AI coding assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Hone (磨石), an interactive AI coding assistant, running within the Hone Agent SDK.`
