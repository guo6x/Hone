...
export function isBridgeEnabled(): boolean {
  // Hone: always enable bridge mode for remote control
  return process.env.USER_TYPE === 'hone' || process.env.HONE_GOD_MODE === '1'
}
