...
const { isDeferredTool } = { isDeferredTool: (null as any) };
const { isSnipBoundaryMessage } = { isSnipBoundaryMessage: (null as any) };
...
null // null // null // require("./messages/SnipBoundaryMessage.js")
              $[65] = t2;
            } else {
              t2 = $[65];
            }
