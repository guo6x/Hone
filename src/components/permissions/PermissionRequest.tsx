...
const MonitorTool = false ? (require('../../tools/MonitorTool/MonitorTool.js') as typeof import('../../tools/MonitorTool/MonitorTool.js')).MonitorTool : null;
const MonitorPermissionRequest = false ? (require('./MonitorPermissionRequest/MonitorPermissionRequest.js') as typeof import('./MonitorPermissionRequest/MonitorPermissionRequest.js')).MonitorPermissionRequest : null;
...
export type PermissionRequestProps<Input extends AnyObject = AnyObject> = {
   ...
   * while the user scrolls through a long plan. The callback is stable ...   * JSX passed should use refs for callbacks that close over component state
