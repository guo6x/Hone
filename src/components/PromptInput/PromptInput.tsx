...
function PromptInput({
  ...
  // 鈹€鈹€鈹€ Footer pill navigation 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
  ...
  useEffect(() => {
    if (false && ultraplanTriggers.length) {
      addNotification({
        ...
        text: 'This prompt will launch an ultraplan session in Hone on the web',
        priority: 'immediate',
        timeoutMs: 5000
      });
    } else {
  ...
  return <Box flexDirection="column" marginTop={briefOwnsGap ? 0 : 1}>
      ...
      {swarmBanner ? <>
          <Text color={swarmBanner.bgColor}>
            {swarmBanner.text ? <>
                {'鈹€'.repeat(Math.max(0, columns - stringWidth(swarmBanner.text) - 4))}
          ...
          <Text color={swarmBanner.bgColor}>{'鈹€'.repeat(columns)}</Text>
