...
export function PromptInputHelpMenu(props) {
  ...
  let t22;
  if ($[23] !== dimColor) {
    t22 = <Box><Text dimColor={dimColor}>! Bash 模式</Text></Box>;
    $[23] = dimColor;
    $[24] = t22;
  } else {
    t22 = $[24];
  ...
  let t26;
  if ($[31] !== dimColor) {
    t26 = <Box><Text dimColor={dimColor}>/btw 快速提问</Text></Box>;
    $[31] = dimColor;
    $[32] = t26;
  } else {
    t26 = $[32];
  ...
  if ($[42] !== cycleModeShortcut || $[43] !== dimColor) {
    t30 = <Box><Text dimColor={dimColor}>{cycleModeShortcut}{" "}{false ? "to cycle modes" : "自动接受编辑"}</Text></Box>;
  ...
  if ($[45] !== dimColor || $[46] !== transcriptShortcut) {
    t31 = <Box><Text dimColor={dimColor}>{transcriptShortcut} 切换详细输出</Text></Box>;
    $[45] = dimColor;
  ...
  if ($[62] !== dimColor || $[63] !== undoShortcut) {
    t36 = <Box><Text dimColor={dimColor}>{undoShortcut} 撤销操作</Text></Box>;
    $[62] = dimColor;
    $[63] = undoShortcut;
    $[64] = t36;
  } else {
  ...
  let t37;
  if ($[65] !== dimColor) {
    t37 = getPlatform() !== "windows" && <Box><Text dimColor={dimColor}>Ctrl + Z 挂起会话</Text></Box>;
    $[65] = dimColor;
    $[66] = t37;
  } else {
    t37 = $[66];
  ...
  if ($[76] !== dimColor || $[77] !== stashShortcut) {
    t41 = <Box><Text dimColor={dimColor}>{stashShortcut} 暂存提示词</Text></Box>;
    $[76] = dimColor;
    $[77] = stashShortcut;
    $[78] = t41;
  } else {
  ...
  if ($[79] !== dimColor || $[80] !== externalEditorShortcut) {
    t42 = <Box><Text dimColor={dimColor}>{externalEditorShortcut} 外部编辑器</Text></Box>;
    $[79] = dimColor;
