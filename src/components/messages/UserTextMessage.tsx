  ...
  if (feature("KAIROS_GITHUB_WEBHOOKS")) {
    if (param.text.startsWith("<github-webhook-activity>")) {
      ...
      if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = { UserGitHubWebhookMessage: (null as any) };
        $[9] = t1;
      } else {
        t1 = $[9];
      }
  ...
  if (feature("FORK_SUBAGENT")) {
    if (param.text.includes("<fork-boilerplate>")) {
      ...
      if ($[32] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = { UserForkBoilerplateMessage: (null as any) };
        $[32] = t1;
      } else {
        t1 = $[32];
      }
  ...
  if (feature("UDS_INBOX")) {
    if (param.text.includes("<cross-session-message")) {
      ...
      if ($[36] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = { UserCrossSessionMessage: (null as any) };
        $[36] = t1;
      } else {
        t1 = $[36];
      }
  ...
  if (feature("KAIROS") || feature("KAIROS_CHANNELS")) {
    if (param.text.includes("<channel source=\"")) {
      ...
      if ($[40] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = { UserChannelMessage: (null as any) };
        $[40] = t1;
      } else {
        t1 = $[40];
      }
