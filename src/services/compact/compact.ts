...
export const ERROR_MESSAGE_INCOMPLETE_RESPONSE =
  'Compaction interrupted 路 This may be due to network issues ...please try again.'
 ...
 * the loader uses this to patch head->抋nchor and anchor's-other-children->抰ail.
 *
...
export async function compactConversation(
  ...
  try {
    ...
    // post-compact turn. Empty message history ->diff against nothing ->    // announces the full set.
    ...
    // compact API call's total usage (input_tokens 鈮?preCompactTokenCount),
 ...
 *
 * Files already present as Read tool results in preservedMessages are skipped ... * re-injecting identical content the model can already see in the preserved tail
