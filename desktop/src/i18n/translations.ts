...
const zh: Translations = {
  ...
  gwStopping: '停止中…',
  gwSearch: '搜索对话…',
  gwPlaceholder: '对 Gateway 说点什么…',
  gwSend: '发送',
  gwQuickDispatch: '派发到 CLI',
  gwQuickStatus: '查看状态',
  gwQuickSchedule: '查看日程',
  gwQuickCanvas: '打开画布',
  gwWelcome: '你好，我是 Hone Gateway。我 24 小时在线，可以帮你调度任务、监控机器、管理日程。需要我做什么？',
...
const en: Translations = {
  ...
  gwPlaceholder: 'Message Gateway…',
  gwSend: 'Send',
  gwQuickDispatch: 'Dispatch to CLI',
  gwQuickStatus: 'Check Status',
  gwQuickSchedule: 'View Schedules',
  gwQuickCanvas: 'Open Canvas',
  gwWelcome: "Hi, I'm Hone Gateway. I'm online 24/7, ready to schedule tasks, monitor machines, and manage your workflow. What can I do for you?",
